...
import { createAgent, createStudent, deleteAgent, editAgent, filterStudents, getAgentsList, getStudentHistory, getStudentsImage, myProfile, searchAndFilterStudents } from '../controllers/userController';
...
webRouter.get('/user/student/image/:id',authorizedUser, getStudentsImage);
